...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
  ...
  <header>
    ...
    <div class="container" style="margin-top:5%">
        <h4 class="text-center">Fiche de réservation</h4><hr/>
        <form method="POST" action="reservation_traitement.php">
            ...
            <div class="form-group div-form">
                ...
                <input type="date" class=""name="date_de_debut" value="<?= $data['date_debut'] ?>" readonly >
            
            
                <label for="heure_de_debut" class="espace">Heure de début</label>
                <input type="time" name="heure_de_debut" value="<?= $data['heure_debut'] ?>" readonly >
            </div>
            <div class="form-group div-form">
                <label for="date_de_fin" class="date">Date de fin</label>
                <input type="date" name="date_de_fin" value="<?= $data['date_fin'] ?>" readonly >
          
                <label for="heure_de_fin" class="espace">Heure de fin</label>
                <input type="time" name="heure_de_fin" value="<?= $data['heure_fin'] ?>" readonly >
            </div>
            ...
            <label for="num_secu">Nom moniteur</label>
                <select name="num_secu" class="form-control" readonly>
        ...
        <div class="form-group div-form">
            ...
            ?>
            <?php
            if($data['activite'] == "bouee"){
            ?>
                <option value="bouee">Bouee</option>
            <?php
            }
            ?>
            <?php
            if($data['activite'] == "bateau"){
            ?>
        ...
        <div class="form-group div-form">
                ...
                <select name="id_equip" class="form-control" readonly>
            ...
            <div class="form-group div-form">
                ...
                <input type="text" class="form-control" name="cout_global" value="<?= $data['cout_global'] ?>" readonly>
            </div>
            <div class="form-group div-form">
                <label for="cout_unitaire">Coût unitaire</label>
                <input type="text" class="form-control" name="cout_unitaire" value="<?= $data['cout_unitaire'] ?>" readonly>
            </div>
            ...
            <!-- <a href="" class="btn btn-warning submit">Imprimer</a> -->
            <a href="reservation.php" class="btn btn-secondary submit">Retour aux réservations</a>
            <a href="reservation_edit.php?id=<?= $data['num_resa'] ?>" class="btn btn-success submit">Modifier réservation</a>
            <a href="?supprimer_reservation=<?= $data['num_resa'] ?>" class="btn btn-danger submit">Supprimer réservation</a>
        </form>
    </div>
    <script>
        function hideDiv() {
